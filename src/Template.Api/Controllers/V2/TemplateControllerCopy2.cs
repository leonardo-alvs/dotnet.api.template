...
[ApiVersion("2.0")]
public class TemplateControllerCopy2 : BaseController
{
    private readonly ITemplateService _templateTests;

    public TemplateControllerCopy2(NotificationContext notificationContext, ITemplateService templateTests)
