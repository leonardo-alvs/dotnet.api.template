...
[ApiVersion("2.0")]
public class TemplateControllerCopy : BaseController
{
    private readonly ITemplateService _templateTests;

    public TemplateControllerCopy(NotificationContext notificationContext, ITemplateService templateTests)
